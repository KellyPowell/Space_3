...
public interface Spaceship {
    ...
    boolean canCarry(Item cargo);   // a method that takes an Item as an argument and returns true if the rocket can carry such item or false if it will exceed the weight limit.


    void carry(Item cargo);         // carry: a method that also takes an Item object and updates the current weight of the rocket.
